...
Interactive docs and demos are availble on https://@kollorg/magnam-iure.dev/#/docs/api.
...
- Install:
  ...
  ```bash
  > npm i -save @kollorg/magnam-iure
  ```

- Require:

  ```javascript
  require('@kollorg/magnam-iure')
...
```html
<script src="https://cdn.jsdelivr.net/gh/mattaylor/@kollorg/magnam-iure@main/@kollorg/magnam-iure.min.js"></script>
...
```javascript
const _ = require('@kollorg/magnam-iure')
